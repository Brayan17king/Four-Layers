...
namespace WebApi.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUnitOfWork unitOfWork, IOptions<JWT> jwt, IPasswordHasher<UserEntity> passwordHasher)
        {
            _jwt = jwt.Value;
        ...
        public async Task<string> AddRoleAsync(AddRoleDto model)
        {
            ...
            if (result == PasswordVerificationResult.Success)
            {
                var rolExists = _unitOfWork.Roles
                                            .Find(u => u.NombreRol.ToLower() == model.Role.ToLower())
                                            .FirstOrDefault();
        ...
        private JwtSecurityToken CreateJwtToken(UserEntity usuario)
        {
